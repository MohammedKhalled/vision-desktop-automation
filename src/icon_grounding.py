    ...
    def _llm_vision_fallback(self):
        ...
        try:
            ...
            region_response = client.models.generate_content(
                model=model_name,
                contents=[screenshot, build_region_proposal_prompt()],
            )
            ...
            if region is None:
                print("   [LLM Vision] Stage 1 failed — cannot locate icon.")
                return None
            ...
            if rel_coords is None:
                print("   [LLM Vision] Stage 2 failed — cannot locate icon in crop.")
                return None
